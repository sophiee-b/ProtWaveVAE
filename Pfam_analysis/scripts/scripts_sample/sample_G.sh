...
# path variables
export data_path='../.././data/protein_families/G_protein/pfam_G_protein.csv'
export alignment=False
export output_results_path='../.././outputs/train_sess/pfam/Gprotein/training_results.csv'
export model_output_path='../.././outputs/train_sess/pfam/Gprotein/G_model.pth'
export dataset_split=0 # 1: train/valid | 0: train

# model training variables
export SEED=42
export homolog_option=3 # 0: CM | 1: S1A | 2: lactamase | 3: Gprotein | 4: DHFR
...
export folder_path='../.././outputs/prediction/pfam/Gprotein'
export samples_output_path='../.././outputs/prediction/pfam/Gprotein/Gprotein_sample_sequences.csv'
