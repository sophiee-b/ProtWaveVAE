...
# path variables
export data_path='../.././data/protein_families/DHFR/pfam_DHFR.csv'
export alignment=False
export output_results_path='../.././outputs/train_sess/pfam/DHFR/training_results.csv'
export model_output_path='../.././outputs/train_sess/pfam/DHFR/DHFR_model.pth'
export dataset_split=0 # 1: train/valid | 0: train

# model training variables
export SEED=42
export homolog_option=4 # 0: CM | 1: S1A | 2: lactamase | 3: Gprotein | 4: DHFR
...
export folder_path='../.././outputs/prediction/pfam/DHFR'
